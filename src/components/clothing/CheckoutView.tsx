        ...
        <div>
          ...
          {step === 2 && (
            ...
            >
              ...
              {/* Stripe Express Checkout — shown on payment step */}
              {stripeStatus?.configured && (
                <div className="mt-4">
                  ...
                  <button
                    ...
                    className="w-full h-11 bg-black text-white rounded-sm text-sm font-medium hover:bg-black/90 transition-colors flex items-center justify-center gap-2 mb-2"
                  >
                  ...
                  <button
                    onClick={handleStripeCheckout}
                    className="w-full h-11 bg-white border border-border text-foreground rounded-sm text-sm font-medium hover:bg-muted transition-colors flex items-center justify-center gap-2"
                  >
